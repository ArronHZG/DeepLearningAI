...
{\color{incolor}In [{\color{incolor}4}]:} \PY{k+kn}{import} \PY{n+nn}{numpy} \PY{k}{as} \PY{n+nn}{np}
        ...
        \PY{k+kn}{from} \PY{n+nn}{testCases\PYZus{}v4} \PY{k}{import} \PY{o}{*}
...
initialization for the biases. Use \texttt{np.zeros(shape)}.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}7}]:} \PY{c+c1}{\PYZsh{} GRADED FUNCTION: initialize\PYZus{}parameters}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}9}]:} \PY{n}{parameters} \PY{o}{=} \PY{n}{initialize\PYZus{}parameters}\PY{p}{(}\PY{l+m+mi}{3}\PY{p}{,}\PY{l+m+mi}{2}\PY{p}{,}\PY{l+m+mi}{1}\PY{p}{)}
...
\NormalTok{        parameters[}\StringTok{"W"} \OperatorTok{+} \BuiltInTok{str}\NormalTok{(L)] }\OperatorTok{=}\NormalTok{ np.random.randn(layer_dims[}\DecValTok{1}\NormalTok{], layer_dims[}\DecValTok{0}\NormalTok{]) }\OperatorTok{*} \FloatTok{0.01}
\NormalTok{        parameters[}\StringTok{"b"} \OperatorTok{+} \BuiltInTok{str}\NormalTok{(L)] }\OperatorTok{=}\NormalTok{ np.zeros((layer_dims[}\DecValTok{1}\NormalTok{], }\DecValTok{1}\NormalTok{))}
\end{Highlighting}
\end{Shaded}

    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}10}]:} \PY{c+c1}{\PYZsh{} GRADED FUNCTION: initialize\PYZus{}parameters\PYZus{}deep}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}11}]:} \PY{n}{parameters} \PY{o}{=} \PY{n}{initialize\PYZus{}parameters\PYZus{}deep}\PY{p}{(}\PY{p}{[}\PY{l+m+mi}{5}\PY{p}{,}\PY{l+m+mi}{4}\PY{p}{,}\PY{l+m+mi}{3}\PY{p}{]}\PY{p}{)}
         \PY{n+nb}{print}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{W1 = }\PY{l+s+s2}{\PYZdq{}} \PY{o}{+} \PY{n+nb}{str}\PY{p}{(}\PY{n}{parameters}\PY{p}{[}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{W1}\PY{l+s+s2}{\PYZdq{}}\PY{p}{]}\PY{p}{)}\PY{p}{)}
         \PY{n+nb}{print}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{b1 = }\PY{l+s+s2}{\PYZdq{}} \PY{o}{+} \PY{n+nb}{str}\PY{p}{(}\PY{n}{parameters}\PY{p}{[}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{b1}\PY{l+s+s2}{\PYZdq{}}\PY{p}{]}\PY{p}{)}\PY{p}{)}
         \PY{n+nb}{print}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{W2 = }\PY{l+s+s2}{\PYZdq{}} \PY{o}{+} \PY{n+nb}{str}\PY{p}{(}\PY{n}{parameters}\PY{p}{[}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{W2}\PY{l+s+s2}{\PYZdq{}}\PY{p}{]}\PY{p}{)}\PY{p}{)}
         \PY{n+nb}{print}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{b2 = }\PY{l+s+s2}{\PYZdq{}} \PY{o}{+} \PY{n+nb}{str}\PY{p}{(}\PY{n}{parameters}\PY{p}{[}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{b2}\PY{l+s+s2}{\PYZdq{}}\PY{p}{]}\PY{p}{)}\PY{p}{)}
...
\texttt{W.shape} may help.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}12}]:} \PY{c+c1}{\PYZsh{} GRADED FUNCTION: linear\PYZus{}forward}
         ...
         \PY{l+s+sd}{    cache \PYZhy{}\PYZhy{} a python dictionary containing \PYZdq{}A\PYZdq{}, \PYZdq{}W\PYZdq{} and \PYZdq{}b\PYZdq{} ; stored for computing the backward pass efficiently}
         \PY{l+s+sd}{    \PYZdq{}\PYZdq{}\PYZdq{}}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}13}]:} \PY{n}{A}\PY{p}{,} \PY{n}{W}\PY{p}{,} \PY{n}{b} \PY{o}{=} \PY{n}{linear\PYZus{}forward\PYZus{}test\PYZus{}case}\PY{p}{(}\PY{p}{)}
...
\item
  \textbf{Sigmoid}:
  \(\sigma(Z) = \sigma(W A + b) = \frac{1}{ 1 + e^{-(W A + b)}}\). We
  have provided you with the \texttt{sigmoid} function. This function
  returns \textbf{two} items: the activation value "\texttt{a}" and a
  "\texttt{cache}" that contains "\texttt{Z}" (it's what we will feed in
  to the corresponding backward function). To use it you could just
  call:

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{A, activation_cache }\OperatorTok{=}\NormalTok{ sigmoid(Z)}
\end{Highlighting}
\end{Shaded}
\item
  \textbf{ReLU}: The mathematical formula for ReLu is
  \(A = RELU(Z) = max(0, Z)\). We have provided you with the
  \texttt{relu} function. This function returns \textbf{two} items: the
  activation value "\texttt{A}" and a "\texttt{cache}" that contains
  "\texttt{Z}" (it's what we will feed in to the corresponding backward
  function). To use it you could just call:

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{A, activation_cache }\OperatorTok{=}\NormalTok{ relu(Z)}
\end{Highlighting}
\end{Shaded}
\end{itemize}
...
correct activation function.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}14}]:} \PY{c+c1}{\PYZsh{} GRADED FUNCTION: linear\PYZus{}activation\PYZus{}forward}
         ...
         \PY{l+s+sd}{    cache \PYZhy{}\PYZhy{} a python dictionary containing \PYZdq{}linear\PYZus{}cache\PYZdq{} and \PYZdq{}activation\PYZus{}cache\PYZdq{};}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}15}]:} \PY{n}{A\PYZus{}prev}\PY{p}{,} \PY{n}{W}\PY{p}{,} \PY{n}{b} \PY{o}{=} \PY{n}{linear\PYZus{}activation\PYZus{}forward\PYZus{}test\PYZus{}case}\PY{p}{(}\PY{p}{)}
...
\texttt{list.append(c)}.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}17}]:} \PY{c+c1}{\PYZsh{} GRADED FUNCTION: L\PYZus{}model\PYZus{}forward}
         ...
         \PY{l+s+sd}{    \PYZdq{}\PYZdq{}\PYZdq{}}
             ...
             \PY{k}{for} \PY{n}{l} \PY{o+ow}{in} \PY{n+nb}{range}\PY{p}{(}\PY{l+m+mi}{1}\PY{p}{,} \PY{n}{L}\PY{p}{)}\PY{p}{:}
                 ...
                 \PY{c+c1}{\PYZsh{}\PYZsh{}\PYZsh{} START CODE HERE \PYZsh{}\PYZsh{}\PYZsh{} (≈ 2 lines of code)}
                 \PY{n}{A}\PY{p}{,} \PY{n}{cache} \PY{o}{=} \PY{n}{linear\PYZus{}activation\PYZus{}forward}\PY{p}{(}\PY{n}{A}\PY{p}{,}\PY{n}{parameters}\PY{p}{[}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{W}\PY{l+s+s2}{\PYZdq{}}\PY{o}{+}\PY{n+nb}{str}\PY{p}{(}\PY{n}{l}\PY{p}{)}\PY{p}{]}\PY{p}{,}\PY{n}{parameters}\PY{p}{[}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{b}\PY{l+s+s2}{\PYZdq{}}\PY{o}{+}\PY{n+nb}{str}\PY{p}{(}\PY{n}{l}\PY{p}{)}\PY{p}{]}\PY{p}{,}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{relu}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
             ...
             \PY{c+c1}{\PYZsh{}\PYZsh{}\PYZsh{} START CODE HERE \PYZsh{}\PYZsh{}\PYZsh{} (≈ 2 lines of code)}
             \PY{n}{AL}\PY{p}{,} \PY{n}{cache} \PY{o}{=} \PY{n}{linear\PYZus{}activation\PYZus{}forward}\PY{p}{(}\PY{n}{A}\PY{p}{,}\PY{n}{parameters}\PY{p}{[}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{W}\PY{l+s+s2}{\PYZdq{}}\PY{o}{+}\PY{n+nb}{str}\PY{p}{(}\PY{n}{L}\PY{p}{)}\PY{p}{]}\PY{p}{,}\PY{n}{parameters}\PY{p}{[}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{b}\PY{l+s+s2}{\PYZdq{}}\PY{o}{+}\PY{n+nb}{str}\PY{p}{(}\PY{n}{L}\PY{p}{)}\PY{p}{]}\PY{p}{,}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{sigmoid}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
             \PY{n}{caches}\PY{o}{.}\PY{n}{append}\PY{p}{(}\PY{n}{cache}\PY{p}{)}
             \PY{c+c1}{\PYZsh{}\PYZsh{}\PYZsh{} END CODE HERE \PYZsh{}\PYZsh{}\PYZsh{}}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}18}]:} \PY{n}{X}\PY{p}{,} \PY{n}{parameters} \PY{o}{=} \PY{n}{L\PYZus{}model\PYZus{}forward\PYZus{}test\PYZus{}case\PYZus{}2hidden}\PY{p}{(}\PY{p}{)}
...
\[-\frac{1}{m} \sum\limits_{i = 1}^{m} (y^{(i)}\log\left(a^{[L] (i)}\right) + (1-y^{(i)})\log\left(1- a^{[L](i)}\right)) \tag{7}\]
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}19}]:} \PY{c+c1}{\PYZsh{} GRADED FUNCTION: compute\PYZus{}cost}
         ...
         \PY{l+s+sd}{    \PYZdq{}\PYZdq{}\PYZdq{}}
             ...
             \PY{n}{cost} \PY{o}{=} \PY{o}{\PYZhy{}}\PY{l+m+mi}{1}\PY{o}{/}\PY{n}{m}\PY{o}{*}\PY{n}{np}\PY{o}{.}\PY{n}{sum}\PY{p}{(}\PY{n}{np}\PY{o}{.}\PY{n}{multiply}\PY{p}{(}\PY{n}{Y}\PY{p}{,}\PY{n}{np}\PY{o}{.}\PY{n}{log}\PY{p}{(}\PY{n}{AL}\PY{p}{)}\PY{o}{+}\PY{n}{np}\PY{o}{.}\PY{n}{multiply}\PY{p}{(}\PY{p}{(}\PY{l+m+mi}{1}\PY{o}{\PYZhy{}}\PY{n}{Y}\PY{p}{)}\PY{p}{,}\PY{n}{np}\PY{o}{.}\PY{n}{log}\PY{p}{(}\PY{l+m+mi}{1}\PY{o}{\PYZhy{}}\PY{n}{AL}\PY{p}{)}\PY{p}{)}\PY{p}{)}\PY{p}{)}
             \PY{c+c1}{\PYZsh{}\PYZsh{}\PYZsh{} END CODE HERE \PYZsh{}\PYZsh{}\PYZsh{}}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}20}]:} \PY{n}{Y}\PY{p}{,} \PY{n}{AL} \PY{o}{=} \PY{n}{compute\PYZus{}cost\PYZus{}test\PYZus{}case}\PY{p}{(}\PY{p}{)}
...
linear\_backward().
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}21}]:} \PY{c+c1}{\PYZsh{} GRADED FUNCTION: linear\PYZus{}backward}
         ...
         \PY{l+s+sd}{    \PYZdq{}\PYZdq{}\PYZdq{}}
             ...
             \PY{n}{dW} \PY{o}{=} \PY{l+m+mi}{1}\PY{o}{/}\PY{n}{m}\PY{o}{*}\PY{n}{np}\PY{o}{.}\PY{n}{dot}\PY{p}{(}\PY{n}{dZ}\PY{p}{,}\PY{n}{A\PYZus{}prev}\PY{o}{.}\PY{n}{T}\PY{p}{)}
             \PY{n}{db} \PY{o}{=} \PY{l+m+mi}{1}\PY{o}{/}\PY{n}{m}\PY{o}{*}\PY{n}{np}\PY{o}{.}\PY{n}{sum}\PY{p}{(}\PY{n}{dZ}\PY{p}{,}\PY{n}{axis}\PY{o}{=}\PY{l+m+mi}{1}\PY{p}{,}\PY{n}{keepdims}\PY{o}{=}\PY{k+kc}{True}\PY{p}{)}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}22}]:} \PY{c+c1}{\PYZsh{} Set up some test inputs}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
dA\_prev = [[ 0.51822968 -0.19517421]
...
\emph{LINEAR-\textgreater{}ACTIVATION} layer.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}23}]:} \PY{c+c1}{\PYZsh{} GRADED FUNCTION: linear\PYZus{}activation\PYZus{}backward}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}24}]:} \PY{n}{dAL}\PY{p}{,} \PY{n}{linear\PYZus{}activation\PYZus{}cache} \PY{o}{=} \PY{n}{linear\PYZus{}activation\PYZus{}backward\PYZus{}test\PYZus{}case}\PY{p}{(}\PY{p}{)}
...
LINEAR -\textgreater{} SIGMOID} model.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}25}]:} \PY{c+c1}{\PYZsh{} GRADED FUNCTION: L\PYZus{}model\PYZus{}backward}
         ...
         \PY{l+s+sd}{    \PYZdq{}\PYZdq{}\PYZdq{}}
             ...
             \PY{c+c1}{\PYZsh{}\PYZsh{}\PYZsh{} START CODE HERE \PYZsh{}\PYZsh{}\PYZsh{} (1 line of code)}
             \PY{n}{dAL} \PY{o}{=} \PY{o}{\PYZhy{}} \PY{p}{(}\PY{n}{np}\PY{o}{.}\PY{n}{divide}\PY{p}{(}\PY{n}{Y}\PY{p}{,} \PY{n}{AL}\PY{p}{)} \PY{o}{\PYZhy{}} \PY{n}{np}\PY{o}{.}\PY{n}{divide}\PY{p}{(}\PY{l+m+mi}{1} \PY{o}{\PYZhy{}} \PY{n}{Y}\PY{p}{,} \PY{l+m+mi}{1} \PY{o}{\PYZhy{}} \PY{n}{AL}\PY{p}{)}\PY{p}{)}  \PY{c+c1}{\PYZsh{} derivative of cost with respect to AL}
             \PY{c+c1}{\PYZsh{}\PYZsh{}\PYZsh{} END CODE HERE \PYZsh{}\PYZsh{}\PYZsh{}}
             ...
             \PY{n}{current\PYZus{}cache} \PY{o}{=} \PY{k+kc}{None}
             \PY{n}{grads}\PY{p}{[}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{dA}\PY{l+s+s2}{\PYZdq{}} \PY{o}{+} \PY{n+nb}{str}\PY{p}{(}\PY{n}{L} \PY{o}{\PYZhy{}} \PY{l+m+mi}{1}\PY{p}{)}\PY{p}{]}\PY{p}{,} \PY{n}{grads}\PY{p}{[}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{dW}\PY{l+s+s2}{\PYZdq{}} \PY{o}{+} \PY{n+nb}{str}\PY{p}{(}\PY{n}{L}\PY{p}{)}\PY{p}{]}\PY{p}{,} \PY{n}{grads}\PY{p}{[}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{db}\PY{l+s+s2}{\PYZdq{}} \PY{o}{+} \PY{n+nb}{str}\PY{p}{(}\PY{n}{L}\PY{p}{)}\PY{p}{]} \PY{o}{=} \PY{n}{linear\PYZus{}activation\PYZus{}backward}\PY{p}{(}\PY{n}{dAL}\PY{p}{,} \PY{n}{caches}\PY{p}{[}\PY{o}{\PYZhy{}}\PY{l+m+mi}{1}\PY{p}{]}\PY{p}{,} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{sigmoid}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
             \PY{c+c1}{\PYZsh{}\PYZsh{}\PYZsh{} END CODE HERE \PYZsh{}\PYZsh{}\PYZsh{}}
             ...
             \PY{k}{for} \PY{n}{l} \PY{o+ow}{in} \PY{n+nb}{reversed}\PY{p}{(}\PY{n+nb}{range}\PY{p}{(}\PY{n}{L} \PY{o}{\PYZhy{}} \PY{l+m+mi}{1}\PY{p}{)}\PY{p}{)}\PY{p}{:}
                 ...
                 \PY{n}{dA\PYZus{}prev\PYZus{}temp}\PY{p}{,} \PY{n}{dW\PYZus{}temp}\PY{p}{,} \PY{n}{db\PYZus{}temp} \PY{o}{=} \PY{n}{linear\PYZus{}activation\PYZus{}backward}\PY{p}{(}\PY{n}{grads}\PY{p}{[}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{dA}\PY{l+s+s2}{\PYZdq{}} \PY{o}{+} \PY{n+nb}{str}\PY{p}{(}\PY{n}{l} \PY{o}{+} \PY{l+m+mi}{1}\PY{p}{)}\PY{p}{]}\PY{p}{,} \PY{n}{current\PYZus{}cache}\PY{p}{,} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{relu}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}26}]:} \PY{n}{AL}\PY{p}{,} \PY{n}{Y\PYZus{}assess}\PY{p}{,} \PY{n}{caches} \PY{o}{=} \PY{n}{L\PYZus{}model\PYZus{}backward\PYZus{}test\PYZus{}case}\PY{p}{(}\PY{p}{)}
...
{[}-0.14175655 0.48317296{]}{[} 0.01663708 -0.05670698{]}{]}
...
\(W^{[l]}\) and \(b^{[l]}\) for \(l = 1, 2, ..., L\).
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}29}]:} \PY{c+c1}{\PYZsh{} GRADED FUNCTION: update\PYZus{}parameters}
         ...
         \PY{l+s+sd}{    \PYZdq{}\PYZdq{}\PYZdq{}}
             ...
             \PY{k}{for} \PY{n}{l} \PY{o+ow}{in} \PY{n+nb}{range}\PY{p}{(}\PY{n}{L}\PY{p}{)}\PY{p}{:}
                 \PY{n}{parameters}\PY{p}{[}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{W}\PY{l+s+s2}{\PYZdq{}} \PY{o}{+} \PY{n+nb}{str}\PY{p}{(}\PY{n}{l} \PY{o}{+} \PY{l+m+mi}{1}\PY{p}{)}\PY{p}{]} \PY{o}{\PYZhy{}}\PY{o}{=} \PY{n}{learning\PYZus{}rate}\PY{o}{*}\PY{n}{grads}\PY{p}{[}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{dW}\PY{l+s+s2}{\PYZdq{}} \PY{o}{+} \PY{n+nb}{str}\PY{p}{(}\PY{n}{l} \PY{o}{+} \PY{l+m+mi}{1}\PY{p}{)}\PY{p}{]}
                 \PY{n}{parameters}\PY{p}{[}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{b}\PY{l+s+s2}{\PYZdq{}} \PY{o}{+} \PY{n+nb}{str}\PY{p}{(}\PY{n}{l} \PY{o}{+} \PY{l+m+mi}{1}\PY{p}{)}\PY{p}{]} \PY{o}{\PYZhy{}}\PY{o}{=} \PY{n}{learning\PYZus{}rate}\PY{o}{*}\PY{n}{grads}\PY{p}{[}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{db}\PY{l+s+s2}{\PYZdq{}} \PY{o}{+} \PY{n+nb}{str}\PY{p}{(}\PY{n}{l} \PY{o}{+} \PY{l+m+mi}{1}\PY{p}{)}\PY{p}{]}
             \PY{c+c1}{\PYZsh{}\PYZsh{}\PYZsh{} END CODE HERE \PYZsh{}\PYZsh{}\PYZsh{}}
             \PY{k}{return} \PY{n}{parameters}
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}30}]:} \PY{n}{parameters}\PY{p}{,} \PY{n}{grads} \PY{o}{=} \PY{n}{update\PYZus{}parameters\PYZus{}test\PYZus{}case}\PY{p}{(}\PY{p}{)}
